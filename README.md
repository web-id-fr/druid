...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/druid.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/druid)
...
```bash
php artisan vendor:publish --tag="druid-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="druid-config"
```
...
```bash
php artisan vendor:publish --tag="druid-views"
```

## Usage

```php
$druid = new Webid\Druid();
echo $druid->echoPhrase('Hello, Webid!');
```
